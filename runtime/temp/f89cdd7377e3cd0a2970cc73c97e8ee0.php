<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\wamp64\www\Web_test\public/../application/admin\view\category\edit.html";i:1499842368;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form class="form form-horizontal" id="form-article-add" method="POST" action="<?php echo url('category/save'); ?>">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $category['name']; ?>" placeholder="" id="articletitle" name="name">
			</div>
		</div>
		<div class="row cl">
