<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wamp64\www\Web_test\public/../application/admin\view\index\index.html";i:1499658402;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('category/index'); ?>" data-title="生活分类管理" href="javascript:void(0)">生活分类管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="__STATIC__/admin/h-ui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
