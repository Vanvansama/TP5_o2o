<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wamp64\www\Web_test\public/../application/admin\view\bis\apply.html";i:1500344629;s:74:"D:\wamp64\www\Web_test\public/../application/admin\view\public\header.html";i:1500512995;s:74:"D:\wamp64\www\Web_test\public/../application/admin\view\public\footer.html";i:1500512994;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
  ...
  <div class="mt-20">
	<table class="table table-border table-bordered table-bg table-hover table-sort">
	  ...
	  <tr class="text-c">
		...
		<td class="td-status"><a href="<?php echo url('bis/status',['id'=>$vo['id'], 'status'=>1]); ?>" 
			title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
		<td class="td-manage">
			<a style="text-decoration:none" class="ml-5" 
				onClick="o2o_edit('商户入驻详情数据','<?php echo url('bis/detail', ['id'=>$vo['id']]); ?>')" 
				href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
			<a style="text-decoration:none" class="ml-5" 
				onClick="o2o_del('<?php echo url('bis/status', ['id'=>$vo['id'], 'status'=>-1]); ?>')" 
				href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a> 
			<a style="text-decoration:none" class="ml-5"  
				href="<?php echo url('bis/status',['id'=>$vo['id'], 'status'=>2]); ?>" title="不通过">
