<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp64\www\Web_test\public/../application/admin\view\bis\detail.html";i:1500512447;s:74:"D:\wamp64\www\Web_test\public/../application/admin\view\public\header.html";i:1500512995;s:74:"D:\wamp64\www\Web_test\public/../application/admin\view\public\footer.html";i:1500512994;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
  ...
  <form class="form form-horizontal" >
      ...
      <div class="formControls col-xs-8 col-sm-2">
				...
				<select name="city_id" class="select cityId">
                  ...
                  <option value="<?php echo $vo['id']; ?>" 
                    <?php if($bisData['city_id'] == $vo['id']): ?> selected="selected"<?php endif; ?>><?php echo $vo['name']; ?>
                  </option>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        ...
        <img  id="upload_org_code_img" src="<?php echo $bisData['logo']; ?>">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        ...
        <img  id="upload_org_code_img_other" src="<?php echo $bisData['licence_logo']; ?>">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-3"> <span class="select-box">
				<select name="category_id" class="select categoryId">
                  ...
                  <option value="<?php echo $vo['id']; ?>"
                    <?php if($locationData['category_id'] == $vo['id']): ?> selected="selected"<?php endif; ?>><?php echo $vo['name']; ?>
                  </option>
                  <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
				</span>
...
<script type="text/javascript" src="__STATIC__/admin/h-sui/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
<script>
  var SCOPE = {
