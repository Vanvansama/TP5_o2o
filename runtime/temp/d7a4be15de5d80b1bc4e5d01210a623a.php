<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wamp64\www\Web_test\public/../application/index\view\index\index.html";i:1500864249;}*/ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="__STATIC__/index/css/common.css" rel="stylesheet" type="text/css" />
	...
	<body>
		<div class="hmtop">
			...
			<div class="am-container header">
				<ul class="message-l">
					<div class="topMessage">
						<div class="menu-hd">
							<?php if($user): ?>
							<a href="" target="_top" class="h">欢迎您：<?php echo $user->username; ?></a>
							<a href="<?php echo url('user/logout'); ?>" target="_top">退出登陆</a>
							<?php else: ?>
							<a href="<?php echo url('user/login'); ?>" target="_top" class="h">亲，请登录</a>
							<a href="<?php echo url('user/register'); ?>" target="_top">免费注册</a>
							<?php endif; ?>
							<a href="<?php echo url('bis/login/index'); ?>" target="_top">商户中心</a>
						</div>
					</div>
				</ul>
				<ul class="message-r">
				...
				<div class="nav white">
					...
					<div class="logoBig">
						<li><img src="__IMG__/logobig.png" /></li>
					</div>
			...
			<div class="shopNav">
			    ...
			    <div class="bannerTwo">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<?php if(is_array($featured) || $featured instanceof \think\Collection || $featured instanceof \think\Paginator): $i = 0; $__LIST__ = $featured;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$featured): $mod = ($i % 2 );++$i;?>
								<li class="banner1"><a href="<?php echo $featured['url']; ?>"><img src="<?php echo $featured['image']; ?>" /></a></li>
								...
								<div class="category-content" id="guide_2">
									...
									<div class="category" style="box-shadow:none ;margin-top: 2px;">
										<ul class="category-list navTwo" id="js_climit_li">
											...
											<li>
												<div class="category-info">
													<h3 class="category-name b-category-name">
														<i><img src="__IMG__/cake.png"></i><a href="#" target="_blank" class="ml-22" title="<?php echo $cat[0]; ?>"><?php echo $cat[0]; ?></a>
													</h3>
													<em>&gt;</em>
												</div>
														...
														<div class="area-bg">
															<div class="menu-srot">
																<div class="sort-side">
																	...
																	<dl class="dl-sort">
																		<dt><span title="<?php echo $vo['name']; ?>"><?php echo $vo['name']; ?></span></dt>
																		<dd><a title="代填充" href="#"><span>代填充</span></a></dd>
																		<dd><a title="代填充" href="#"><span>代填充</span></a></dd>
																		<dd><a title="代填充" href="#"><span>代填充</span></a></dd>
																		<dd><a title="代填充" href="#"><span>代填充</span></a></dd>
																		<dd><a title="代填充" href="#"><span>代填充</span></a></dd>
																...
																<div class="brand-side">
																	<dl class="dl-sort"><dt><span>实力商家</span></dt>
																		<dd><a rel="nofollow" title="糯米团子官方旗舰店" target="_blank" href="#" rel="nofollow"><span  class="red" >糯米团子官方旗舰店</span></a></dd>
																		<dd><a rel="nofollow" title="糯米团子1号店" target="_blank" href="#" rel="nofollow"><span >糯米团子1号店</span></a></dd>
																		<dd><a rel="nofollow" title="糯米团子2号店" target="_blank" href="#" rel="nofollow"><span  class="red" >糯米团子2号店</span></a></dd>
																		<dd><a rel="nofollow" title="糯米团子3号店" target="_blank" href="#" rel="nofollow"><span >糯米团子3号店</span></a></dd>
																		<dd><a rel="nofollow" title="糯米团子4号店" target="_blank" href="#" rel="nofollow"><span  class="red" >糯米团子4号店</span></a></dd>
																		<dd><a rel="nofollow" title="糯米团子5号店" target="_blank" href="#" rel="nofollow"><span  class="red" >糯米团子5号店</span></a></dd>
																	</dl>
																</div>
															</div>
														</div>
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li>
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
                                 ...
                                 <!--比较多的导航	-->										
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li>
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="__IMG__/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="__IMG__/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="__IMG__/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="__IMG__/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="__IMG__/moneysmall.jpg" />
				...
				<!--各类活动-->
				<div class="row">
					<?php if(is_array($small_featured) || $small_featured instanceof \think\Collection || $small_featured instanceof \think\Paginator): $i = 0; $__LIST__ = $small_featured;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$small_featured): $mod = ($i % 2 );++$i;?>
					<li><a><img src="<?php echo $small_featured['image']; ?>"/></a></li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<div class="clear"></div>	
					<!--走马灯 -->
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="__IMG__/TJ2.jpg"></img>
									<span>[特惠]</span>洋河年末大促，低至两件五折							
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="__IMG__/TJ.jpg"></img>
			...
			<div class="shopMainbg">
				<div class="shopMain" id="shopmain">
                     ...
                     <div class="sale-mt">
					  ...
					  <div class="am-g am-g-fixed sale">
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="__IMG__/sale3.jpg" /></a>
							</div>
                           <div class="s-info">
						...
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="__IMG__/sale2.jpg" /></a>
							</div>
                           <div class="s-info">
                           	   <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                           	   <div class="s-price">￥<b>9.90</b>
						...
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="__IMG__/sale1.jpg" /></a>
							</div>
                           <div class="s-info">
                           	   <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                           	   <div class="s-price">￥<b>9.90</b>
					...
					<div class="clear "></div>
					<?php if(is_array($cats) || $cats instanceof \think\Collection || $cats instanceof \think\Paginator): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cats): $mod = ($i % 2 );++$i;?>
            <div class="f1">
					<!--甜点-->
					
					<div class="am-container " >
						<div class="shopTitle ">
							<h4 class="floor-title"><?php echo $cats[0]; ?></h4>
							<div class="floor-subtitle"><em class="am-icon-caret-left"></em><h3>都有一个故事</h3></div>
							<div class="today-brands " style="right:0px ;top:13px;">
								<?php if(is_array($cats[1]) || $cats[1] instanceof \think\Collection || $cats[1] instanceof \think\Paginator): $i = 0; $__LIST__ = $cats[1];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					...
					<div class="am-g am-g-fixed floodSix ">				
						...
						<div class="am-u-sm-7 am-u-md-5 am-u-lg-2 text-two big">
								...
								<a href="# "><img src="__IMG__/act1.png" /></a>						
						</div>
						<?php if(is_array($deal) || $deal instanceof \think\Collection || $deal instanceof \think\Paginator): $i = 0; $__LIST__ = $deal;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$deal): $mod = ($i % 2 );++$i;?>
						<li>
						<div class="am-u-md-2 am-u-lg-2 text-three">
							...
							<div class="outer-con ">
								...
								<div class="sub-title ">
									¥<?php echo $deal['current_price']; ?>
								</div>
								
							</div>
							<a href="<?php echo url('detail/index', ['id'=>$deal['id']]); ?>"><img src="<?php echo $deal['image']; ?>" /></a>
						</div>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>	
						<li>
						<div class="am-u-md-2 am-u-lg-2 text-three">
							...
							<a href="# "><img src="<?php echo $deal['image']; ?>" /></a>
						</div>
						</li>
					<li>
						<div class="am-u-md-2 am-u-lg-2 text-three">
					...
					<div class="footer ">
						...
						<div class="footer-bd ">
							<p>
								...
								<a href="# ">联系我们</a>
								<a href="# ">网站地图</a>
								<em>© 2015-2025 糯米集团 版权所有<a href="" target="_blank" title="模板之家"></a> - Collect from <a href="" title="" target="_blank"></a></em>
							</p>
						</div>
					</div>
				</div>
			...
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item ">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								<p class="avatar_imgbox "><img src="__IMG__/no-img_mid_.jpg " /></p>
								<ul class="user_info ">
									<li>用户名：sl1903</li>
									<li>级&nbsp;别：普通会员</li>
								</ul>
					...
					<div id="brand " class="item ">
						<a href="#">
							<span class="wdsc "><img src="__IMG__/wdsc.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我的收藏
							<i class="icon_arrow_right_black "></i>
					...
					<div id="broadcast " class="item ">
						<a href="# ">
							<span class="chongzhi "><img src="__IMG__/chongzhi.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我要充值
							<i class="icon_arrow_right_black "></i>
					...
					<div class="quick_toggle ">
						...
						<li class="qtitem ">
							...
							<div class="mp_qrcode " style="display:none; "><img src="__IMG__/weixin_code_145.png " /><i class="icon_arrow_white "></i></div>
						</li>
						<li class="qtitem ">
